...
public class BossWaterSkill : Skill
{
    ...
    public override void UseSkill()
    {
        ...
        for (int i = 1; i <= bulletCount; i++)
        {
            ...
            water.transform.position = User.transform.position + new Vector3(0,10,0);
            ...
            water2.transform.position = User.transform.position + new Vector3(0, 10, 0);
            ...
            water3.transform.position = User.transform.position + new Vector3(0, 10, 0);
