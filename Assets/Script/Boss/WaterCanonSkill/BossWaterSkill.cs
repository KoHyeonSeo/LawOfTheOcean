...
public class BossWaterSkill : Skill
{
    ...
    public override void UseSkill()
    {
        ...
        for (int i = 1; i <= bulletCount; i++)
        {
            ...
            water.GetComponent<Rigidbody>().AddForce(dir.normalized * 500,ForceMode.Force);
            ...
            water2.GetComponent<Rigidbody>().AddForce(dir.normalized * 500, ForceMode.Force);
            ...
            water3.GetComponent<Rigidbody>().AddForce(dir.normalized * 500, ForceMode.Force);
